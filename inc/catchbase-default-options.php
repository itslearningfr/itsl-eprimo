...
// this is the content at the top left
	$catchbase_content['top_left'] 	= '<a href="http://www.e-primo.fr">Portail <sup>ENT</sup></a>';
// this is the content at the bottom right
	...
	$catchbase_content['top_right']	= '&nbsp;<a class="genericon_parent genericon genericon-key" target="_self" href="https://cas.itslearning.com/cas-eprimo/login?service=https://eprimo.itslearning.com/Index.aspx">se connecter</a>';
...
// this is the reférence to the partners of the project
	...
	<div><a href="http://www.ac-creteil.fr/"><img src="'. get_template_directory_uri() . '/images/partenaires/ac-nantes.png" alt="Académie de Créteil"></a></div>
